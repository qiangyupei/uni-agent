...
Executed via `python3 -I -c`; use only the standard library and never
import agent-generated code. Reward, AST and implementation/metric binding
decisions remain in the host Task.
"""
